...
import lab8.annotation.ManyToOne;
...
public class EntityManagerImpl implements EntityManager {
  ...
  Field[] getFields(Object object) {
    ...
    if (object.getClass().getCanonicalName().equals("lab8.classes.Users")) {
      Field[] personFields = Users.class.getSuperclass().getDeclaredFields();
      Field[] userfield = Users.class.getDeclaredFields();
      Field[] fields = new Field[userfield.length + personFields.length];
      Arrays.setAll(fields, i ->
              (i < personFields.length ? personFields[i] : userfield[i - personFields.length]));
      return fields;
...
//          System.out.println("columnName " + columnName);
          ...
          //если есть ссылка на др таблицу
            ...
            Class<?> clazz2 = Class.forName("lab8.classes." + fieldNameForMethod);
